...
def translate_article_data(article_data):
        ...
        for key, value in article_data.items():
            try:
                ...
                translated_data[key] = value
        print(f'Translated Text: {translated_data}')
        return translated_data

def translate_text(text):
    """
    Translate a single piece of text using lang_trans.
    Handles errors and returns original text if translation fails.
    """
    try:
        translated = lang_trans(text)
        if translated:
            return translated
        else:
...
#     artcle = {
#         "title": "Aramco invertirá 110.000 millones de dólares en proyectos energéticos",
#         "description": "Saudi Aramco planea invertir 110 mil millones de dólares en proyectos energéticos durante los próximos 10 años.",
#         "Language": "es",
#     }
#     translate = translate_article_data(artcle)
#     print(translate)